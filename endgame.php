...
<section class="mt-6 ml-5 mr-5">
    ...
    <!-- Close icon -->
     <div class="flex items-center gap-3 w-full">
        ...
        <div class="flex-1 flex ml-[595px]">
...
<section class="bg-white mt-10 ml-120 rounded-2xl p-6 w-[852px]">
    ...
    <!-- Cards -->
     <div class="items-center flex justify-center rounded-3xl w-[740px] bg-[#fafafa]">
        <img src="./image/92eebac8235507f924d1578ab054aa0ee168bc42.png" class="w-[214px]">
    </div>
     <div class="flex gap-4 mt-10">
        <div class="border-2 ml-10 flex w-[230px] p-2 rounded-2xl justify-start">
            <p>Forest</p>
        </div>
        <div class="border-2 flex w-[230px] p-2 rounded-2xl justify-start">
            <p>butterfly</p>
        </div>
        <div class="border-2 flex w-[230px] p-2 rounded-2xl justify-start">
            <p>grass</p>
