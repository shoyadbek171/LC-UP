...
<div class="flex">
    ...
    <aside class="w-64 bg-white p-6">
        <ul class="flex flex-col gap-4 nn p-4 rounded-xl">
            ...
            <a href="group.php">
                <li class="flex cursor-pointer nn w-44 h-10 items-center gap-2 p-2 rounded-xl transition-all">
                    <svg class="text-[#A1A1A1] w-6 hover:text-[#FFFFFF]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="currentColor">
                            ...
                            <path d="m5.082 14.254l-.036.055a8.3 8.3 0 0 0-1.271 5.08a9.7 9.7 0 0 1-1.765-.44l-.115-.04a.56.56 0 0 1-.373-.487l-.01-.121Q1.5 18.15 1.5 18a3.75 3.75 0 0 1 3.582-3.746m15.144 5.135a8.3 8.3 0 0 0-1.308-5.135a3.75 3.75 0 0 1 3.57 4.047l-.01.56.56 0 0 1-.373.486l-.115.04q-.851.302-1.764.441" />
                        </g>
                    </svg>
                    <span>Groups</span>
                </li>
            ...
            <a href="records.php">
                <li class="flex cursor-pointer text-[#A1A1A1] nn w-44 h-10 items-center gap-2 p-2 rounded-2xl transition-all">
                    <i class="fa-solid fa-list-ul"></i>
                    <span>Records</span>
                </li>
            </a>
            <a href="https://t.me/odilov_IT">
                <li class="flex cursor-pointer nn w-44 h-10 items-center gap-2 p-2 rounded-xl transition-all">
            ...
            <a href="face-id.php">
                <li class="flex cursor-pointer nn w-44 h-10 items-center gap-2 p-2 rounded-xl  bg-blue-500 text-white transition-all">
    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex bg-white border-2 border-[#E5E7EB] rounded-xl p-1">
                    ...
                    <a href="#" class="px-6 py-2 text-sm text-[#6B7280] hover:bg-[#007AFF] hover:text-white rounded-lg transition">Teachers</a>
                    <a href="#" class="px-6 py-2 text-sm text-[#6B7280] hover:bg-[#007AFF] hover:text-white rounded-lg transition">Employees</a>
                </div>
        ...
        <div class="bg-[#FAFAFA] rounded-xl p-4 shadow-sm overflow-hidden">
            ...
            <div class="grid bg-[#ffffff] rounded-2xl mt-2 grid-cols-[220px_1fr_1fr_180px] items-center px-6 py-4 border-b border-[#F2F2F7]">
                ...
                <!--  Come -->
                <div class="flex items-center face-idTask gap-3 ml-36">
                ...
                <!-- Left -->
                <div class="flex items-center gap-3">
                    <div class="flex items-center face-idL gap-2 border-2 border-[#E5E7EB] rounded-xl p-2 h-8 w-20 bg-white">
            ...
            <div class="grid bg-[#ffffff] rounded-2xl mt-2 grid-cols-[220px_1fr_1fr_180px] items-center px-6 py-4">
                ...
                <div class="flex items-center gap-3">
                    <div class="flex items-center face-idTask gap-2 border-2 ml-36 border-[#E5E7EB] rounded-xl h-8 p-2 w-20 bg-white">
                        <img src="./image/camera.svg" class="w-4">
                        <hr>
                        <span class="font-semibold text-sm">9:00</span>
                    </div>
                ...
                <!-- Left -->
                <div class="flex items-center gap-3">
                    <div class="flex items-center gap-2 face-idL border-2 border-[#E5E7EB] rounded-xl p-2 h-8 w-20 bg-white">
                        <img src="./image/icon.svg" class="w-4">
                        <span class="font-semibold text-sm">9:00</span>
                    </div>
                    <span class="text-green-600 text-sm font-medium">+20 min</span>
            ...
            <div class="grid bg-[#ffffff] rounded-2xl mt-2 grid-cols-[220px_1fr_1fr_180px] items-center px-6 py-4 border-b border-[#F2F2F7]">
                ...
                <div class="flex items-center ml-36 gap-3">
                    <div class="flex items-center face-idTask gap-2 border-2 border-[#E5E7EB] rounded-xl h-8 p-2 w-20 bg-white">
                        <img src="./image/camera.svg" class="w-4">
                        <hr>
                        <span class="font-semibold text-sm">9:00</span>
                    </div>
                ...
                <div class="flex justify-end text-center">
                    <button class="p-4 bg-[#CBD5E1] rounded-2xl w-12 h-12 flex items-center">
            ...
            <div class="grid bg-[#ffffff] rounded-2xl mt-2 grid-cols-[220px_1fr_1fr_180px] items-center px-6 py-4">
                ...
                <div class="flex items-center ml-36 gap-3">
                    <div class="flex items-center gap-2 face-idTask border-2 border-[#E5E7EB] rounded-xl h-8 p-2 w-20 bg-white">
                        <img src="./image/camera.svg" class="w-4">
                        <hr>
                        <span class="font-semibold text-sm">9:00</span>
                    </div>
            ...
            <div class="grid bg-[#ffffff] rounded-2xl mt-2 grid-cols-[220px_1fr_1fr_180px] items-center px-6 py-4 border-b border-[#F2F2F7]">
                ...
                <div class="flex ml-36 items-center gap-3">
                    <div class="flex items-center face-idTask gap-2 face-idTask border-2 border-[#E5E7EB] rounded-xl h-8 p-2 w-20 bg-white">
                        <img src="./image/camera.svg" class="w-4">
                        <hr>
                        <span class="font-semibold text-sm">9:00</span>
                    </div>
            ...
            <div class="grid bg-[#ffffff] rounded-2xl mt-2 grid-cols-[220px_1fr_1fr_180px] items-center px-6 py-4">
                ...
                <div class="flex ml-36 items-center gap-3">
                    <div class="flex items-center face-idTask gap-2 border-2 border-[#E5E7EB] rounded-xl h-8 p-2 w-20 bg-[#ffffff]">
                        <img src="./image/camera.svg" class="w-4">
                        <hr>
                        <span class="font-semibold text-sm">9:00</span>
                    </div>
                ...
                <!-- Left -->
                <div class="flex items-center gap-3">
                    <div class="flex items-center gap-2 face-idL border-2 border-[#E5E7EB] rounded-xl p-2 h-8 w-20 bg-[#ffffff]">
                        <img src="./image/icon.svg" class="w-4">
                        <span class="font-semibold text-sm">9:00</span>
                    </div>
                    <span class="text-green-600 text-sm font-medium">+20 min</span>
...
<section id="face-id2" class="fixed inset-0 z-50 hidden items-center justify-center bg-[#09131A80]">
...
<section id="face-id3" class="fixed inset-0 z-50 hidden items-center justify-center bg-[#09131A80]">
    <div class="bg-white rounded-3xl p-6 w-[483px] max-w-5xl mx-4 relative">

        <!-- Header -->
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-xl font-semibold">Left</h1>
            <i id="Fback_2" class="fa-solid fa-x cursor-pointer text-gray-500 hover:text-black border border-[#E1E2E5] rounded-xl p-2"></i>
        </div>
