...
<section class="mt-6 ml-5 mr-5">
    ...
    <div><button class="p-2 bg-[#0B7BE3] h-[48px] text-white ml-40 rounded-2xl w-30"><span>2/5</span></button></div>
</div>
    <!-- Profile section -->
...
<section id="to" class="bg-[#fafafa] mt-10 ml-120 rounded-2xl p-6 w-[852px]  -sm">
    <h1 class="mb-5 font-bold">Question</h1>
    <div><img src="./image/7edbd956f40114e1da8f44184a69c4c12e7089b3.png" alt=""></div>
    <div class="p-4 bg-[#ffff] mt-5 rounded-2xl">
    <p>a) to students</p>
    <p class="mt-2">b) from 23 different countries</p>
    <p class="mt-2">c) for future goals</p></div>
      <div class="p-4 bg-[#ffff] mt-5 rounded-2xl">
        <p>1) <span class="text-blue-500"><input class="w-6 text-center" type="text" name="" placeholder="a" ></span> to students</p>
    <p class="mt-2">2) <span class="text-blue-500"><input class="w-6 text-center" type="text" name="" placeholder="..." ></span> from 23 different countries</p>
    <p class="mt-2">3) <span class="text-blue-500"><input class="w-6 text-center" type="text" name="" placeholder="..." ></span> for future goals</p></div>
</section>
