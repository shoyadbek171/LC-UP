        ...
        <section class="mt-10 rounded-2xl ml-80 p-6">
            <div class="max-w-[600px] ml-80 mt-10">
                ...
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-1/2 px-2 mb-3">
                        <div class="border-2 border-[#F12E31] bg-[#F12E311F] py-3 text-center rounded-2xl text-gray-800 font-medium">flower</div>
                    </div>
                    ...
                    <div class="w-1/2 px-2 mb-3">
                        <div class="border-2 border-gray-200 py-3 text-center rounded-2xl text-gray-800 font-medium bg-white hover:border-blue-400 cursor-pointer transition">leaf</div>
                    </div>
